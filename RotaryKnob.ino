...
//  pinMode(rotaryEncoderBtn, INPUT_PULLUP); // btn
}
...
//    if (rotaryEncoderDtValue == LOW) {
      // INCREMENT
      if (rotaryMode == 0) {
		setting_right_wheel_distance = encoder.getPositionLimited(setting_right_wheel_distance, -MAX_DISTANCE, MAX_DISTANCE, rotaryIncrement);
//        setting_right_wheel_distance += rotaryIncrement;
//        if (setting_right_wheel_distance > 99999) {
//			setting_right_wheel_distance = 99999;
//		}
      }
      else if (rotaryMode == 1) {
		setting_right_wheel_speed = encoder.getPositionLimited(setting_right_wheel_speed, -MAX_SPEED, MAX_SPEED);
//        setting_right_wheel_speed += 1;
//        if (setting_right_wheel_speed > 50) {
//			setting_right_wheel_speed = 50;
//		}
      }
      else if (rotaryMode == 2) {
		setting_left_wheel_speed = encoder.getPositionLimited(setting_left_wheel_speed, -MAX_SPEED, MAX_SPEED);
//        setting_left_wheel_speed += 1;
//        if (setting_left_wheel_speed > 50) {
//			setting_left_wheel_speed = 50;
//		}
      }
      else {
		setting_left_wheel_distance = encoder.getPositionLimited(setting_left_wheel_distance, -MAX_DISTANCE, MAX_DISTANCE, rotaryIncrement);
//        setting_left_wheel_distance += rotaryIncrement;
//        if (setting_left_wheel_distance > 99999) {
//			setting_left_wheel_distance = 99999;
//		}
      }
      report();
//    }
